                        ...
                        <?php
                            while($row = mysqli_fetch_array($result)) {
                                ...
                                <tr>
                                    ...
                                    <td><?=$row['type']?></td>
                                    <td><?=$row['Status']?></td>
                                    <td><?php $_SESSION['status']="approved"; $_SESSION['email'] =$row['email']; echo "<a href='php/updatetable.php' /><span class='mdi-action-done'></span>&nbsp;";?><?php  echo "<a href='php/removeduser.php' /><i class='mdi-action-delete'/>"; ?></td>
                                </tr>
                        <?php
                        }
                        mysqli_close($conn);
