...
<div id="main">
    ...
    <div id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation collapsible collapsible-accordion">
            ...
            <li class="no-padding"></li>
            <li class="bold active"><a href="policedashboard.php" class="waves-effect waves-cyan"><i class="mdi-action-account-circle"></i> Team</a>
            </li>
            <li class="no-padding">
            <li class="bold"><a class="collapsible-header  waves-effect waves-cyan"><i class="mdi-editor-border-all"></i> Tables</a>
                <div class="collapsible-body">
                    <ul>
                        <li><a href="New_firs_admin.php">New Fir</a></li>
                        <li><a href="Commentedfirs.php">Accepted FIR's</a></li>
