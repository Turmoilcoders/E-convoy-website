    ...
    <div id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation collapsible collapsible-accordion">
            ...
            <li class="bold active">
                <?php
                echo "<a href='#' class='waves-effect waves-cyan'><i class='mdi-action-dashboard'></i> Dashboard</a>";
                ?>
            </li>
            </li>
            <li class="bold active"><a href="#" class="waves-effect waves-cyan"><i class="mdi-action-account-circle"></i> Team</a>
            </li>
            </li>
            ...
            <div class="row">
                <div class="col s12 m8 l9">
                    <table id="data-table-simple" class="responsive-table display"   width="100%">
                        ...
                        {
                            $conn= new mysqli('localhost','root','','econvoy');
                            $sql = "SELECT * FROM fir WHERE `Status` ='No' ";
                            $result = mysqli_query($conn,$sql);
                            print "
                            <tr>
                                <th>Name</th>
                        ...
                        else
                        {
                            ...
                            while($row = mysqli_fetch_array($result)) {
                                ...
                                <tr>
                                    ...
                                    <td><?=$row['Status']?></td>
                                    <td><?=$row['Comment']?></td>
                                    <td><?php $_SESSION['status']="fir_approved"; $_SESSION['fir'] =$row['uuid']; echo "<a href='php/updatetable.php' /><span class='mdi-action-done'></span>&nbsp;";?><?php  echo "<a href='php/removedfir.php' /><i class='mdi-action-delete'/>"; ?></td>
                                </tr>
                            <?php
                            }
                        }
