        ...
        $_SESSION['status'] ="done";
			if(isset($_SESSION['name']))
            {
                if($_SESSION['status'] == "done") {
                    echo '<center class="color"><br><h3> Your FIR has been registered and you will be notified soon.</h3></center>';
                    echo '<center style="color: coral">Your FIR number is <p class="color">' .$_SESSION['firno']. '</p> You can check your FIR At <a href="http://localhost:90/econvoy/fir.php">Status Tab</a></center>';
                    echo '<center style="color: coral"><a href="http://localhost:90/econvoy/fir.php">Go back to home </a></center>';
